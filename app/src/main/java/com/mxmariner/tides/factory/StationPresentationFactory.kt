...
class StationPresentationFactory @Inject constructor(
  ...
  fun createPresentation(
    ...
    val levelValueNow =
      station.getPredictionRaw(now, Duration.standardMinutes(1), measureUnit).firstOrNull()?.value
    ...
    val prediction = station.getPredictionRaw(
      start,
    ...
    return StationPresentation(
      prediction, levelNow, station.name, position, station.timeZone,
